...
public class DescriptionPersonWorkerController {
    ...
    public void setPersonIDForPersonWorker(int personID, String data, String description, int transactionID) {
    ...
    public void loadDataForPerson() {
        String sql = "SELECT payment, data, paymentStatus, notice FROM payment_worker WHERE transactionID = ?";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                infoText.setText(
                        "Me pagesë: " + rs.getString("payment") + "€, rreth pageses së për mirmbajtje të varrezave "
