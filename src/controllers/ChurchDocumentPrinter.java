...
public class ChurchDocumentPrinter {
    ...
    private void loadDocumentForPerson() {
        String sql = "SELECT data, payment, paymentData, transactionID, paymentStatus FROM payment_tax WHERE personID = ? ORDER BY paymentData DESC";
    ...
    private void selectedPersonNotice() {
        ...
        if (selectedTransaction != null) {
            ...
            String sql = "SELECT notice FROM payment_tax WHERE transactionID = ?";
